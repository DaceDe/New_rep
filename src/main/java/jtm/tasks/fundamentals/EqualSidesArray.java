...
public class EqualSidesArray {
	 ...
	 * 
	 * {1,2,3,4,3,2,1}: Correct answer 3, because at the 3rd position of the
	 * array, the sum of left side of the index ({1,2,3}) and the sum of the
	 ...
	 * {10,-80,10,10,15,35} They both are equal to 0 when added. (Empty arrays
	 * are equal to 0 in this problem) Index 0 is the place where the left side
